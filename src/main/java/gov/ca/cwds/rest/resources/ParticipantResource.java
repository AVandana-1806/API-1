...
public class ParticipantResource {
  ...
  public ParticipantResource(
      @ParticipantServiceBackedResource ParticipantService participantService) {
  ...
  public Response get(@PathParam("legacyId") @ApiParam(required = true, name = "legacyId",
      value = "The id of the Address to find") String legacyId) {
