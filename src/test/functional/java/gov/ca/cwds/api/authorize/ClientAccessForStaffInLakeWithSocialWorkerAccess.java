...
public class ClientAccessForStaffInLakeWithSocialWorkerAccess extends FunctionalTest {
  ...
  public void shouldReturnKnownRelationshipsOfPerson() {
    ...
    httpRequestHandler.getRequest(clientRelationshipPath, queryParams).then().assertThat()
        .body("relationship_to.legacy_descriptor.legacy_id",
            Matchers.hasItems("4GrHFQK0Fj", "TBCF40g0D8", "3ju7sbi0Co"))
        .and().statusCode(200);
  }
  ...
  public void shouldReturnEmptyWhenPersonHasNoRelationships() {
    ...
    httpRequestHandler.getRequest(clientRelationshipPath, queryParams).then().assertThat()
        .body("relationship_to", empty()).and().statusCode(200);
  }
  ...
  public void shouldReturnErrorWhenUserNotAuthoriziedToAccessClient() {
    ...
    httpRequestHandler.getRequest(clientRelationshipPath, queryParams).then().statusCode(200);
  }
